...
BEGIN
  ...
  IF v_item.active_render_attempt_id IS NOT NULL OR v_item.active_upload_attempt_id IS NOT NULL THEN
    RAISE EXCEPTION 'item still has an active processing attempt';
  END IF;
