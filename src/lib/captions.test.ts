...
describe("professional captions", () => {
  ...
  it("evaluates the active word from the shared project playhead", () => {
    ...
    const doc: EditorDocumentV2 = { version: 2, aspect: "9:16", width: 1080, height: 1920, fps: 30, durationMs: 5000, variables: [], tracks: [], scenes: [{ id: "s", name: "Scene", durationMs: 5000, background: "#000", elements: [] }], audioClips: [], captionClips: [clip], effectClips: [], audioMix: { duckingEnabled: true, duckLevel: 0.22, attackMs: 180, releaseMs: 320 } };
